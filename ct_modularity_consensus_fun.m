function [CiConsensus, consensus] = ct_modularity_consensus_fun(net, gamma, numRand)
%CT_MODULARITY_CONSENSUS_FUN A consensus modularity algorithm
%
%   [CiConsensus, consensus] = ct_modularity_consensus_fun(net, gamma, numRand);
%
%   Inputs:     net,            network
...
%               consensus,      Q term
%
% Written up from code made by Rafael Romero-Garcia aka 'El Cunado', August 2017
