function [ measures ] = ct_make_measures_bin( network, gamma )
%CT_MAKE_MEASURES_BIN Calculates some BCT summary measures
%
%   Based on myHeavyMeasures.m
%
%   measures = ct_make_measures_bin(network, gamma);
%
...
[Ci, Q] = ct_modularity_consensus_fun(network, gamma, 10); %binary
