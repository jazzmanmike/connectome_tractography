function [ nodal_measures, global_measures, hubs_consensus ] = ct_quick_measures( CIJ, n )
%CT_QUICK_MEASURES 
%   Adaption of myHeavyMeasures & hubCapsHeavy plus others
%   Therefore, designed to be 'silent'
%
%   [nodal_measures, global_measures, hubs_consensus] = ct_quick_measures(CIJ, n);
%
...
%   participation, eigenvector, pagerank
%
%   globalMeasures (6) = strength, GC, disconnected, clustering, 
%   global efficiency, betweenness
%
%   NB: semi-metricity deprecated (matlab_bgl compile issue)
%
...
global_measures = [mean(S) max(GC) DC mean(C) Eglob mean(bc)];

nodal_measures = [deg' S cl bc Z P v pr]; 
