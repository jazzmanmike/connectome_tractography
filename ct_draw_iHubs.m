function ct_draw_iHubs( hubs, XYZ )
%CT_DRAW_IHUBS Plots axial view of nodes proportional to 5 individual hub measures
%
...
nHubs = size(hubs, 2); %number of hubs from above
nNodes = size(hubs, 1);
